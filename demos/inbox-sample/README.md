...
inbox-sample/
├── README.md                       ← this file
└── sample-chapter-01/              ← one MinerU task fixture
...
- **Stage 4 misc fallback**: the off-topic placeholder paragraph at the
  end of the chapter carries no outline keyword. When run with a topic
  outline (e.g. sample-outline-v1.yaml), this content is routed to the
...
```bash
pdf2dt-run --inbox inbox-sample/sample-chapter-01 \
           --project demo-sample-chapter \
           --mode B
```
